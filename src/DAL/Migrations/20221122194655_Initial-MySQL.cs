    ...
    public partial class InitialMySQL : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameCapacity", x => x.GameCapacityId);
                    table.ForeignKey(
                        name: "FK_GameCapacity_Capacity_CapacityId",
                        column: x => x.CapacityId,
                        principalTable: "Capacity",
                        principalColumn: "CapacityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameCapacity_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameCapacity_CapacityId",
                table: "GameCapacity",
                column: "CapacityId");

            migrationBuilder.CreateIndex(
                name: "IX_GameCapacity_GameId",
                table: "GameCapacity",
                column: "GameId");
